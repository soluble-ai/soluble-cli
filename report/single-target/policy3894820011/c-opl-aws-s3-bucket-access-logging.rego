...
package policies.c_opl_aws_s3_bucket_access_logging
...
__rego__metadoc__ := {
  "description": "TEST S3 bucket access logging should be enabled. Enabling server access logging provides detailed records for the requests that are made to a S3 bucket. This information is useful for security and compliance auditing purposes.",
  "custom": { "severity": "Critical" },
  "id": "c-opl-aws-s3-bucket-access-logging",
  "title": "TEST S3 bucket access logging should be enabled"
}
