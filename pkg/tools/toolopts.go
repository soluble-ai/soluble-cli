...
func (o *ToolOpts) Register(c *cobra.Command) {
	...
	flags.BoolVar(&o.PrintCLIFindings, "print-findings", false, "Print the list of findings")
...
func (o *ToolOpts) RunTool(tool Interface, printResult bool) (*Result, error) {
	...
	if diropts := tool.GetDirectoryBasedToolOptions(); diropts != nil {
		assessments.ComputePartialFingerprints(diropts.GetDirectory(), result.Findings)
	}
	if printResult {
